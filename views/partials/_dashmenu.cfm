	...
	<div class="span3">
       <div class="well sidebar-nav">
		...
		<!--- TODO: Add a badge to notify unread messages --->
           ...
           <li class="nav-header"><i class="icon-list"></i>Purse</li>
           <li><a href="##"><i class="icon-chevron-right"></i>Products</a></li>
           <li><a href="##"><i class="icon-chevron-right"></i>Sales</a></li>
           <li><a href="##" class="hidden-phone"><i class="icon-chevron-right"></i>Invoices</a></li>
		   <li><a href="##" class="hidden-phone"><i class="icon-chevron-right"></i>Bills</a></li>
